...
- `<BaseIconWrapper>` | `<base-icon-wrapper>` (components/base/BaseIconWrapper.vue)
...
- `<BlocksHighlightSection>` | `<blocks-highlight-section>` (components/blocks/HighlightSection.vue)
