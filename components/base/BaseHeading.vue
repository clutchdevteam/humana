    ...
    classes() {
      ...
      switch (this.size) {
        case 'h1':
          ...
          break
        case 'h2-lg':
          classes.push('font-medium', 'text-3xl', 'lg:text-5xl', 'leading-tighter')
          break
        case 'h2':
          classes.push('font-medium', 'text-2xl', 'lg:text-4xl', 'leading-tighter')
          break
        case 'h3':
          classes.push('font-medium', 'text-xl', 'lg:text-3xl', 'leading-tighter')
          break
        case 'h4':
          classes.push('font-medium', 'text-lg', 'lg:text-2xl', 'leading-tighter')
          break
        case 'h5':
